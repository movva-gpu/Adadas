/* scrolls.js - smooth scrolling library - from https://scrollsjs.com/ */
...
const scrolls = (a, b) => {
	...
	switch (
		(b &&
			...
			(c = void 0 !== b.callback && 'function' == typeof b.callback ? b.callback : void 0)),
		...
		m = n => {
			j || (j = n),
				...
				k < e
					...
					: (window.scrollTo(0, h + d), c && 'function' == typeof c && c(), (j = !1));
		};
	window.requestAnimationFrame(m);
};
try {
